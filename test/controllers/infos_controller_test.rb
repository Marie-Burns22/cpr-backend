...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { content: @info.content, placement: @info.placement, title: @info.title } }, as: :json
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { content: @info.content, placement: @info.placement, title: @info.title } }, as: :json
    assert_response 200
  end
